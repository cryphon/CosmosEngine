...
public:
    ...
    void init_ui();
    std::shared_ptr<ui::UI> get_ui() { return ui_; }

    void init_inputmanager();
    std::shared_ptr<input::InputManager> get_inputmanager() { return input_manager_; }
...
private:
    ...
    std::shared_ptr<core::WindowData> window_data_;
